...
class WebAppRenderingTests(unittest.TestCase):
    ...
    def test_character_stack_prefers_exact_case_alnum_model(self) -> None:
        ...
        with patch.object(main, "load_character_model", return_value=(character_model, ["H"])):
            with patch.object(main, "load_letter_model", return_value=(letter_model, ["H"])):
                with patch.object(main, "load_mixedcase_model", return_value=(mixedcase_model, ["H", "i"])) as mixed_loader:
    ...
    def test_static_website_files_define_upload_and_api_flow(self) -> None:
        ...
        self.assertIn('id="practice-batch"', html)
        ...
        self.assertIn(".practice-coverage-meter", css)
        self.assertIn(".practice-coverage-meter-fill", css)
        ...
        self.assertIn("recommendedBatchLabels", js)
        self.assertIn("renderPracticeBatch", js)
        self.assertIn("nextBatchPracticeLabel", js)
        self.assertIn("selectNextBatchPracticeLabel", js)
        ...
        self.assertIn("practice-batch-button", js)
        self.assertIn("Next batch label", js)
        ...
        self.assertIn("practice-sample-progress", js)
